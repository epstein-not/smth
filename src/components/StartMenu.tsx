...
export const StartMenu = ({ open, apps, onClose, onOpenApp, onReboot, onShutdown, onLogout }: StartMenuProps) => {
  ...
  return (
    <div
      ref={menuRef}
      className="fixed left-3 bottom-[60px] w-[680px] h-[740px] rounded-2xl glass-panel-strong border border-border/50 z-[9999] shadow-2xl overflow-hidden animate-start-menu-in gpu-accelerated"
    >
      {/* Search Bar at Top */}
